...
<body bgcolor="lightgrey">
    ...
    <div style="display: flex;">
        <div class="styleBox" style="border: 1px solid #000;">
            <div>
                <img style="align-self: flex-start " src="./img/Gow.jpg" alt="" height="100%" width="100%">
            </div>
        ...
        <div class="styleBoxt" style="border: 1px solid #000;">
            ...
            <div class="box_game" style="display: block;">
                ...
                <div><span class="valor_fpag"> Marca: Sony Interactive </span> <span class="fpag"> Cód: YUGFRTWAD </span> </div>
                <div class="valor"> R$ 179,99</div>
                <div><span class="parcela"> até 4x de R$45,00 sem juros</span></div>
                <div><span class="fpag"> ou <span class="valor_fpag"> R$ 140,00 </span> via pix</span></div><br>
        ...
        <div class="box_game" style="display: block;">
            ...
            <div><span  class="valor_fpag1"> Especificações </span> </div>
             <div><span class="fpag2">Plataforma: PS4 <br>
                ...
                Data de Lançamento: 20 abril 2018 </span> </div> <br>
                <div><span  class="valor_fpag1"> Descrição do jogo </span> </div>
                <div><span class="fpag2">God of War é um jogo eletrônico de ação-aventura desenvolvido pela Santa Monica Studio e publicado pela Sony Interactive Entertainment. Foi lançado em 20 de abril de 2018 para PlayStation 4 e em 14 de janeiro de 2022 para Microsoft Windows.<br>
