...
<body bgcolor="lightgrey">
    ...
    <div style="display: flex;">
        <div class="styleBox" style="border: 1px solid #000;">
            <div>
                <img style="align-self: flex-start " src="./img/ghost.webp" alt="" height="100%" width="100%">
            </div>
            ...
            <a class="btntop" href="#">
                ...
                <img style="width: 100px; background-color: red;" src="./img/webp" alt="">        
            </a>
        ...
        <div class="styleBoxt" style="border: 1px solid #000;">
            ...
            <div class="box_game" style="display: block;">
                ...
                <div><span class="valor_fpag"> Marca: Tango Gameworks </span> <span class="fpag"> Cód: SWQEFDVSD </span> </div>
                <div class="valor"> R$ 400,00</div>
                <div><span class="parcela"> até 4x de R$100,00 sem juros</span></div>
                <div><span class="fpag"> ou <span class="valor_fpag"> R$ 250,00 </span> via pix</span></div><br>
        ...
        <div class="box_game" style="display: block;">
            ...
            <div><span  class="valor_fpag1"> Especificações </span> </div>
             <div><span class="fpag2">Plataforma: PS4 <br>
                ...
                Data de Lançamento: 25 de março de 2022 </span> </div> <br>
                <div><span  class="valor_fpag1"> Descrição do jogo </span> </div>
                <div><span class="fpag2">Ghostwire: Tokyo é um jogo eletrônico de ação-aventura em primeira pessoa desenvolvido pela Tango Gameworks e publicado pela Bethesda Softworks.<br>
