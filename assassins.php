...
<head>
    ...
    <link rel="stylesheet" href="stylejgs.css">
...
<body bgcolor="lightgrey">
        ...
        <nav>
            <ul class="link_link">
                <li>
                    ...
                    <a style="color:rgb(223, 223, 223) ;" href="index.php">Início
                ...
                <li>
                    ...
                    <a style="color:rgb(238, 238, 238) ;" href="cadastro.php">Cadastro
                ...
                <li>
                    ...
                    <a style="color:rgb(252, 246, 246) ;" href="login.php">
                    Login</a>
                </li>
                <li>
                    <div style="text-align: center;">
                    ...
                    <div style=" text-align: center;">
                        <a style="color:rgb(250, 246, 246) ;" href="sobre.php">About</a>
                ...
                <li>
                    ...
                    <a style="color:rgb(233, 223, 223) ;" href="#">Contact</a>
                </li>
            </ul>
    ...
    <div style="display: flex;">
        <div class="styleBox" style="border: 1px solid #000;">
            <div>
                <img style="align-self: flex-start " src="./img/acval.jpg" alt="" height="100%" width="100%">
            </div>
        ...
        <div class="styleBoxt" style="border: 1px solid #000;">
            
            <div class="box_game" style="display: block;">
                <div class="title_game">Assassins creed Valhalla - PS4</div>
                <div><span class="valor_fpag"> Marca: Ubisoft Montreal </span> <span class="fpag"> Cód: FSACSQWERG </span> </div>
                <div class="valor"> R$ 220,00</div>
                <div><span class="parcela"> até 4x de R$55,00 sem juros</span></div>
                <div><span class="fpag"> ou <span class="valor_fpag"> R$ 150,00 </span> via pix</span></div><br>
                <a style="color: red;" href="omowdf">Assistir ao trailer</a><br>
                <button  class="btn">Comprar</button> 
    ...
    <div class="styleBoxtt" style="border: 1px solid #000;">
            
        <div class="box_game" style="display: block;">
            
            <div class="title_game">Descrição</div>
            <hr> 
            <br>
            
            <div><span  class="valor_fpag1"> Especificações </span> </div>
             <div><span class="fpag2">Plataforma: PS4<br>

                Formato: Mídia Digital Envio Gratuito Por E-mail
                <br>
                Gênero: RPG
                <br>
                Produtora: Ubisoft
                ...
                Data de Lançamento: 10 de novembro de 2020 </span> </div> <br>
                <div><span  class="valor_fpag1"> Descrição do jogo </span> </div>
                <div><span class="fpag2">Navegue pelo gelado Mar do Norte para descobrir e conquistar os reinos divididos da Inglaterra. Realize atividades de caça, pesca, dados e bebida, ou participe de competições nórdicas tradicionais de insultos - ou, como mais conhecidas, rivais verbalmente devastadores por meio da arte de combate Viking de versos ofensivos.<br>
