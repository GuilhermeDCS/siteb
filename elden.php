...
<body bgcolor="lightgrey">
    ...
    <div style="display: flex;">
        <div class="styleBox" style="border: 1px solid #000;">
            <div>
                <img style="align-self: flex-start " src="./img/elden.jpg" alt="" height="100%" width="134%">
            </div>
        ...
        <div class="styleBoxt" style="border: 1px solid #000;">
            ...
            <div class="box_game" style="display: block;">
                <div class="title_game">Elden Ring - PS4</div>
                <div><span class="valor_fpag"> Marca: Bandai Namco </span> <span class="fpag"> Cód: ERFDSAWEQ </span> </div>
                <div class="valor"> R$ 150,00</div>
                <div><span class="parcela"> até 4x de R$37,50 sem juros</span></div>
        ...
        <div class="box_game" style="display: block;">
            ...
            <div><span  class="valor_fpag1"> Especificações </span> </div>
             <div><span class="fpag2">Plataforma: PS4<br>
                ...
                Data de Lançamento: 25 Fevereiro 2022 </span> </div> <br>
                <div><span  class="valor_fpag1"> Descrição do jogo </span> </div>
                <div><span class="fpag2">Elden Ring é um jogo eletrônico de RPG de ação desenvolvido pela FromSoftware e publicado pela Bandai Namco Entertainment. O jogo é um projeto colaborativo entre o diretor Hidetaka Miyazaki e o romancista de fantasia George R. R. Martin.<br>
