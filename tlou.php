...
<body bgcolor="lightgrey">
    ...
    <div style="display: flex;">
        <div class="styleBox" style="border: 1px solid #000;">
            <div>
                <img style="align-self: flex-start " src="./img/tlou.webp" alt="" height="100%" width="100%">
            </div>
        ...
        <div class="styleBoxt" style="border: 1px solid #000;">
            ...
            <div class="box_game" style="display: block;">
                <div class="title_game">The Last Of Us 2 - PS4</div>
                <div><span class="valor_fpag"> Marca: Sony Interactive </span> <span class="fpag"> Cód: QKMF3YEVP </span> </div>
                <div class="valor"> R$ 200,00</div>
                <div><span class="parcela"> até 4x de R$400 sem juros</span></div>
                <div><span class="fpag"> ou <span class="valor_fpag"> R$ 284,90 </span> via pix</span></div><br>
    ...
    <div class="styleBoxtt" style="border: 1px solid #000;">
        ...
        <div class="box_game" style="display: block;">
            ...
            <div><span  class="valor_fpag1"> Especificações </span> </div>
             <div><span class="fpag2">Plataforma: Playstation 4<br>
